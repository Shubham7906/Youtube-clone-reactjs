...
import { Context } from "/src/Context/ContextApi.jsx";
import SuggestionVideoCard from "../SuggestionVideo/SuggestionVideo";
        ...
        <div className="flex flex-col lg:w-[calc(100%-350px)] xl:w-[calc(100%-400px)] px-4 py-3 lg:py-6 overflow-y-auto">
          ...
          <div className="flex justify-between flex-col md:flex-row mt-4">
            <div className="flex">
              ...
              <div className="text-white text-md fonst-semibold flex items-center mr-20">
                  {video?.author?.title}
